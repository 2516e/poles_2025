...
import { FaCartShopping, FaPlus, FaUserInjured } from 'react-icons/fa6';
    ...
    return (
        <Link
            className={clsx(
                ...
                color === 'lime' &&
                    'from-brand-lime to-brand-orange text-black',
                className,
            )}
            {...props}
        >
            {icon ? (
                <>
                    ...
                    >
                        ...
                        {icon === 'plus' && <FaPlus />}
                        {icon === 'profile' && <FaUserInjured />}
                    </div>
                    {/* 🔹 La div ne s'affiche pas si l'icône est "profile" */}
                    {icon !== 'profile' && (
